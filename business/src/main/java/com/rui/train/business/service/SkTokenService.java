...
import com.rui.train.business.enums.RedisKeyPreEnum;
import com.rui.train.business.mapper.SkTokenMapper;
import com.rui.train.business.mapper.cust.SkTokenMapperCust;
...
public class SkTokenService {
    ...
    public boolean validSkToken(Date date, String trainCode, Long memberId) {
        ...
        String lockKey = RedisKeyPreEnum.SK_TOKEN_COUNT + "-" + DateUtil.formatDate(date) + "-" + trainCode;
